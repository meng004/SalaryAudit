...
#pragma warning disable CS0108 // '“FrmRetirement.Scale”隐藏继承的成员“Control.Scale(float)”。如果是有意隐藏，请使用关键字 new。
        private System.Windows.Forms.DataGridViewTextBoxColumn Scale;
#pragma warning restore CS0108 // '“FrmRetirement.Scale”隐藏继承的成员“Control.Scale(float)”。如果是有意隐藏，请使用关键字 new。
