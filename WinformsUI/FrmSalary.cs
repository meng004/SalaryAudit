    ...
    public partial class FrmSalary : Form
    {
        ...
        private IList<Salary> LastSalaries
        {
            get
            {
                ...
                var excelImportCaiWu = new Import<Salary, MapOfSalary>(txt_CaiWuFilePath.Text, index[0], index[1]);
        ...
        private IList<Salary> CurrentSalaries
        {
            get
            {
                ...
                //创建导入对象
                var excelImportGuoKu = new Import<Salary, MapOfSalary>(txt_GuoKuFilePath.Text, index[0], index[1]);
                //创建国库数据项
