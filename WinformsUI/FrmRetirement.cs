    ...
    public partial class FrmRetirement : Form
    {
        ...
        private IList<Retirement> LastSalaries
        {
            get
            {
                ...
                var excelImportCaiWu = new Import<Retirement, MapOfRetirement>(txt_CaiWuFilePath.Text, index[0], index[1]);
        ...
        private IList<Retirement> CurrentSalaries
        {
            get
            {
                ...
                //创建导入对象
                var excelImportGuoKu = new Import<Retirement, MapOfRetirement>(txt_GuoKuFilePath.Text, index[0], index[1]);
                //创建国库数据项
